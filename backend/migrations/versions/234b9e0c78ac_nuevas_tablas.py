...
Revision ID: 234b9e0c78ac
Revises: 
Create Date: 2025-05-19 17:49:18.380352
...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['account_number'], ['bank_account.account_number'], name='fk_payslip_bank'),
